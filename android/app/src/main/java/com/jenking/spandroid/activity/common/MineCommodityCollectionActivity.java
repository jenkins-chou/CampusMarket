...
public class MineCommodityCollectionActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mine_commodity_collection);
    }
    ...
    void getData(){
        if (AccountTool.isLogin(this)){
            ...
            collectPresenter.getAllCollectByProvider(params);
        }
    }
}
