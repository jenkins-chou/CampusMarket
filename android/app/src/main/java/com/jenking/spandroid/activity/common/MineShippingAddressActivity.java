...
public class MineShippingAddressActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mine_shipping_address);
    }
    ...
    public void initData(){
        ...
        data = new ArrayList();
        baseRecyclerAdapter = new BaseRecyclerAdapter<ShippingAddressModel>(this,data,R.layout.activity_shipping_address_list_item) {
            @Override
