...
public class SearchCommodityResultActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_commodity_result);
    ...
    void getData(){
        ...
        commodityPresenter.searchAllMobile(params);
    }
}
