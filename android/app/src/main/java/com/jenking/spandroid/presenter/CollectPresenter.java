...
public class CollectPresenter {
        ...
        new ApiUtil(context)
                ...
                .subscribe(new Observer<ResultModel>() {
                    ...
                    public void onNext(ResultModel resultModel) {
                        //更新视图
                        if (onCallBack!=null){
                            onCallBack.collect(true,resultModel);
                        }
                    }
                    @Override
    ...
    public void getAllCollectByProvider(Map<String,String> params){
        if (params==null)return;
        Log.e("开始请求","p-->"+params.toString());
        new ApiUtil(context)
                .getServer(ApiService.class)
                //记得更改请求接口数据
                .getAllCollectByProvider(params)
                .subscribeOn(Schedulers.io())//后台处理线程
                .observeOn(AndroidSchedulers.mainThread())//指定回调发生的线程
                .subscribe(new Observer<ResultModel>() {
                    @Override
                    ...
                    public void onNext(ResultModel resultModel) {
                        //更新视图
                        if (onCallBack!=null){
                            onCallBack.getAllCollectByProvider(true,resultModel);
                        }
                    }
                    @Override
                    public void onError(Throwable e) {
                        ...
                        e.printStackTrace();
                        if (onCallBack!=null){
                            onCallBack.getAllCollectByProvider(false,e);
                        }
                        //view.failed(e);
                    }
                    @Override
    ...
    public interface OnCallBack{
        void collect(boolean isSuccess, Object object);
        void getAllCollectByProvider(boolean isSuccess, Object object);
